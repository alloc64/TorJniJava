 ...
 */
extern "C" int tor_main_configuration_set_command_line(tor_main_configuration_t *cfg,
                                            int argc, char *argv[]);
...
/** DOCDOC */
extern "C" tor_control_socket_t tor_main_configuration_setup_control_socket(
 ...
 */
extern "C" void tor_main_configuration_free(tor_main_configuration_t *cfg);
 ...
 **/
extern "C" const char *tor_api_get_provider_version(void);
 ...
 */
extern "C" int tor_run_main(const tor_main_configuration_t *);
